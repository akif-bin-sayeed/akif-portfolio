...
function normalize(raw){ const d=structuredClone(window.DEFAULT_SITE_CONTENT); const c=deepMerge(d,raw||{}); if(typeof c.about==='string') c.about={paragraphs:[c.about], stats:d.about.stats, focusAreas:d.about.focusAreas||[]}; c.about.paragraphs=arr(c.about.paragraphs); c.about.stats=arr(c.about.stats); c.about.focusAreas=arr(c.about.focusAreas); return c; }
